          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex max-w-sm mx-auto">
              <input
                ...
                required
                className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-l-lg focus:ring-2 focus:ring-white focus:border-transparent outline-none text-white placeholder-gray-400"
              />
              <button
                type="submit"
                className="bg-white text-black px-6 py-3 rounded-r-lg hover:bg-gray-100 transition-colors flex items-center"
              >
