        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="bg-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-4 px-6 rounded-lg font-medium hover:bg-gray-800 transition-colors flex items-center justify-center space-x-2 group"
              >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8">
                Whether you have questions about our products, need styling advice, or want to learn more about our brand, we're here to help.
              </p>
            </div>
            ...
            {/* Map Placeholder */}
            <div className="mt-12">
              <h3 className="text-xl font-semibold text-black mb-4">Find Us</h3>
